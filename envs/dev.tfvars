...
# Feature Toggles - Development typically has minimal infrastructure
enable_rds         = true
enable_redis       = false
enable_msk         = false
enable_bastion     = true
...
# Note: In real usage, password would be managed via AWS Secrets Manager
...
bastion_key_name      = "atlas-dev-key"
